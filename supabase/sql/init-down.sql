...
ALTER TABLE public."tx_history" DROP CONSTRAINT IF EXISTS tx_history_wallet_address_fkey;

-- Drop txHistory table
DROP TABLE IF EXISTS public.tx_history;

-- Drop foreign key constraints from rewardsHistory
ALTER TABLE public."rewards_history" DROP CONSTRAINT IF EXISTS rewards_history_referral_fkey;
ALTER TABLE public."rewards_history" DROP CONSTRAINT IF EXISTS rewards_history_wallet_address_fkey;
